  ...
  <div class="container-1">
    ...
    <main>
      <div class="row d-flex justify-content-center align-content-center ">
        <div class="col-sm-12 col-md-4">
          <div class="card" style="width: 18rem;height: 12rem;">
            <div class="d-flex justify-content-center pt-3">
              <img src="1.jpg" style="width:90px; height: auto;" class="card-img-top rounded-circle " alt="...">
            </div>
        ...
        <div class="col-sm-12 col-md-4">
          <div class="card" style="width: 18rem ; height: 12rem;">
            <div class="d-flex justify-content-center pt-3">
              <img src="2.png" style="width:90px; height: auto;" class="card-img-top rounded-circle " alt="...">
            </div>
            <div class="card-body p-1 ">
        ...
        <div class="col-sm-12 col-md-4">
          <div class="card" style="width: 18rem;height: 12rem;">
            <div class="d-flex justify-content-center pt-3 ">
              <img src="3.png" style="width:90px; height: auto;" class="card-img-top rounded-circle " alt="...">
            </div>
            <div class="card-body p-1 ">
    ...
    <div id="content1" class="row ">
      <div class="col-12 text-center container-fluid ">
        <h2 class=" bg-info ">Contact Us</h2>
      </div>
          ...
          while ($c_row = mysqli_fetch_assoc($qresult)) {
            ...
            <div class="card" style="width: 20rem;">
              ...
              <div class="card-body p-1 ps-3 pe-3 ">
                <h4 class="card-title m-0 ">Request id :
                  <?php echo $c_row['id']; ?>
                </h4>
                <p class="card-text m-0 ">Name :
                  <?php echo ' ' . $c_row['name']; ?>
                </p>
                <p class="card-text m-0 ">Email :
                  <?php echo ' ' . $c_row['email']; ?>
                </p>
                <p class="card-text m-0 ">Message :
                  <?php echo ' ' . $c_row['message']; ?>
                </p>
              ...
              <div class="card" style="width:14rem;">
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item">
                    <?php echo '' . $row["e_detail"]; ?>
                  </li>
                </ul>
              </div>

              <button type="button" class="btn btn-primary mt-2 send-ambulance-btn" data-bs-toggle="modal"
                data-bs-target="#exampleModal" data-id="<?php echo $row["e_ID"]; ?>">
                SEND AMBULANCE
              </button>
            </div>
